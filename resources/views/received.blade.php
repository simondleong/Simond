        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    @if (!count($dates))
                        <h3 class="text-black">No Received Date Requests Yet</h3>
                    @else
                        <h3 class="text-black">Received Date Requests</h3>
                    @endif
                </div>
            </div>
                                ...
                                <a href="/profile/date/{{ $date->id }}" class="profile-item-hover" target="_blank">
                                    ...
                                    <div class="profile-image clearfix">
                                        ...
                                        <div class="profile-details profile-text">
                                            <h5 class="title">{{ $date->sender->first_name }}&nbsp;{{ $date->sender->last_name }}</h5>
                                            @if ($date->status == 0)
